...
def fetch_words_data(url=data_url, words_data=data_dir):
    ...
    # Path to zip file 
    zip_path = os.path.join(words_data, r"D:\python\ICP_10\DeepLearning_Lesson3\DeepLearning_Lesson3\Word2Vec\data\words.zip")
...
def create_counts(vocab_size=500):
...
with tf.Session() as sess:
    ...
    writer = tf.summary.FileWriter('./graphs/wordvector', sess.graph)
